var adaptUILayout = (function () {
    ...
    var adapt = function (uiWidth) {
        try{
            ...
            var scale = deviceWidth / uiWidth;
            initialContent = isiOS ? 'width=' + deviceWidth + 'px, user-scalable=no, initial-scale=' + scale +',maximum-scale=' + scale : 'width=' + deviceWidth + ', user-scalable=no, initial-scale=' + scale  +',maximum-scale=' + scale +',target-densitydpi=device-dpi'; //'target-densitydpi=' + targetDensitydpi +
            //$("#viewport").remove();
